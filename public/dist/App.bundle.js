...
function typeAhead(search) {
    ...
    searchInput.on('keyup', function (e) {
        // console.log(e.keyCode); prints the actual key being used by the user

        //    if they arent pressing up,down or enter who enters
